...
rankTest('should_return_B_when_rating_given_voyage_zone_china_length_5_history_1_profit_1_zone_east-indies', t => {
  const voyage = {
    zone: 'china',
    length: 15,
  };
...
rankTest('should_return_A_when_rating_given_voyage_zone_china_length_5_history_1_profit_1_zone_china', t => {
  const voyage = {
    zone: 'china',
    length: 15,
  };
...
rankTest('should_return_B_when_rating_given_voyage_zone_china_length_15_history_1_profit_-1_zone_china', t => {
  const voyage = {
    zone: 'china',
    length: 15,
  };
...
rankTest('should_return_B_when_rating_given_voyage_zone_china_length_22_history_10_profit_1_zone_china', t => {
  const voyage = {
    zone: 'china',
    length: 22,
  };
